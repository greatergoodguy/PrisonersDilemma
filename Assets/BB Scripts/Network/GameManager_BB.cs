...
public class GameManager_BB : Photon.MonoBehaviour
{
	...
	public void Start(){
		// Delete the Non-network player
		GameObject disconnectedPlayer = GameObject.Find("OVRPlayerController_BB");
		DebugUtils.Assert(disconnectedPlayer != null);
